...
| File | Topic | Level |
|------|-------|-------|
| [Terraform basics](javascript:dvGo('terraform-basics')) | Terraform fundamentals | Intermediate |
...
| [Ansible playbooks](javascript:dvGo('ansible-playbooks')) | Real-world Ansible playbooks | Advanced |
